...
namespace HierarchicalDataTemplate
{
    public class ListLeagueList : List<League>
    {
        public ListLeagueList()
        {
            ...
            l.Divisions.Add((d = new Division("Premier league")));
            d.Teams.Add(new Team("Standings"));
            d.Teams.Add(new Team("Recent results"));
            d.Teams.Add(new Team("Upcoming fixtures"));
            //d.Teams.Add(new Team("Team IV"));
            //d.Teams.Add(new Team("Team V"));
            l.Divisions.Add((d = new Division("Budesliga 1")));
            d.Teams.Add(new Team("Standings "));
            d.Teams.Add(new Team("Recent results"));
            d.Teams.Add(new Team("Upcoming fixtures"));
            //d.Teams.Add(new Team("Team Green"));
            //d.Teams.Add(new Team("Team Orange"));
            l.Divisions.Add((d = new Division("Budesliga 2")));
            d.Teams.Add(new Team("Standings "));
            d.Teams.Add(new Team("Recent results"));
            d.Teams.Add(new Team("Upcoming fixtures"));
