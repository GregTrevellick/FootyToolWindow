...
namespace HierarchicalDataTemplate
{
    public partial class MainWindow : Window
    {
        ...
        private async Task<IEnumerable<Standing>> GetStandingsAsync(bool shouldShowLeague, bool internalToExternalMappingExists, bool shouldExpandGrid, ExternalLeagueCode externalLeagueCode)
        {
            try
            {
        ...
        private async Task<IEnumerable<FixturePast>> GetFixturePastsAsync(bool shouldShowLeague, bool internalToExternalMappingExists, bool shouldExpandGrid, ExternalLeagueCode externalLeagueCode)
        {
            try
            {
                var theTask = Task.Run(() =>
        ...
        private async Task<IEnumerable<FixtureFuture>> GetFixtureFuturesAsync(bool shouldShowLeague, bool internalToExternalMappingExists, bool shouldExpandGrid, ExternalLeagueCode externalLeagueCode)
        {
            try
            {
                var theTask = Task.Run(() =>
